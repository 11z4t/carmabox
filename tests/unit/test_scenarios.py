...
def _s(**kw):
    d = dict(grid_import_w=2500, ellevio_viktat_kw=1.2, pv_power_w=0,
        battery_soc_1=80, battery_soc_2=80, battery_power_1=0, battery_power_2=0,
...
class TestScenarioBDisk:
    ...
    def test_disk_triggers_grid_guard(self):
        ...
        r = c.cycle(_s(hour=23, grid_import_w=8600, ellevio_viktat_kw=4.3,
                        ev_power_w=4100, disk_power_w=2000))
...
class TestScenarioDSol:
    ...
    def test_pv_surplus_charges_battery(self):
        c = CoordinatorV2()
        c._startup_confirmed = True
        r = c.cycle(_s(hour=10, grid_import_w=-500, pv_power_w=3000,
