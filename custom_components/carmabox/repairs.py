...
class SafetyGuardRepairFlow(RepairsFlow):
    ...
    Suggests increasing min_soc or checking battery temperature sensor.
    """
    ...
    async def async_step_confirm(
        ...
        if user_input is not None:
            ...
            # Mark issue as fixed regardless of action
    ...
    async def _increase_min_soc(self) -> None:
        ...
        new_soc = min(current + 5.0, 50.0)  # Cap at 50%
...
class HubOfflineRepairFlow(ConfirmRepairFlow):
    ...
    Simple confirmation — suggests checking internet connectivity.
    """
